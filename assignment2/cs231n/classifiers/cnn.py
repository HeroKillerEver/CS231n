...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        fc_out, cache_fc = affine_relu_forward(conv_out, W2, b2)
        scores, cache_scores = affine_forward(fc_out, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dfc, dW3, db3 = affine_backward(dscores, cache_scores)
        dW3 += self.reg * self.params['W3']
        loss += 0.5 * self.reg * np.sum(self.params['W2']**2)
        dconv, dW2, db2 = affine_relu_backward(dfc, cache_fc)
